  ...
  return (
    <>
      ...
      >
        ...
        {/* Content */}
        <div className="relative bg-opacity-70 p-0 lg:p-8 rounded-lg text-left max-w-2xl ml-10 sm:ml-16 md:ml-24 lg:ml-32">
          <h1 className="lg:text-8xl text-4xl font-semibold mb-4 text-white">
